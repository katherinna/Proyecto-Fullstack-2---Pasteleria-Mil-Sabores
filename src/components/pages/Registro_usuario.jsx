...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if(!form) return console.log("No se encontro #formUsuario")
    ...
    form.addEventListener("submit", async (e) => {
     ...
     if(!nombre) return mensajeInput.innerText = "Nombre en blanco"; 
     if(!apellidos) return mensajeInput.innerText = "Apellidos en blanco";  
     if(!validarCorreo(correo)) return mensajeInput.innerText = "Correo incorrecto"; 
     if(!validarPassword(contrasena)) return mensajeInput.innerText = "Contraseña debe tener más de 6 dígitos";
     if(!validarEdad(fecha_nacimiento)) return mensajeInput.innerText = "tiene x años"; //la verdad no sé que poner aquí, o si va, esta validación es para el código promocional
     ...
     try{
      ...
      mensajeInput.innerText = "El formulario fue enviado correctamente :) ";
